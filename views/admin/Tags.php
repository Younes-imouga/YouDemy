...
<body class="flex flex-col min-h-screen bg-gray-50 text-gray-800 font-sans">
  ...
  <main class="flex-grow container mx-auto mt-8">
    <h1 class="text-3xl font-bold text-gray-800 mb-6 text-center">Tag Management</h1>

        <!-- Add New Category -->
        <div class="w-[1000px] mx-auto overflow-x-auto bg-white shadow rounded-lg p-4 mb-6">
            <div class="mt-6">
                <form class="flex items-center space-x-4 mb-4 w-full justify-between">
                <h2 class="text-xl font-bold text-gray-800 mb-2">Add New Tag:</h2>
                <input type="text" placeholder="Tag Name" class="p-2 border border-gray-300 rounded w-1/3" />
                <button type="submit" class="w-1/6 bg-teal-600 text-white px-4 py-2 rounded hover:bg-teal-700">Add</button>
                </form>
            </div>
        </div>
        <!-- Table for Category Management -->
        <div class="w-[1000px] mx-auto overflow-x-auto bg-white shadow rounded-lg p-4">
